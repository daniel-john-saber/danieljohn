      ...
      <div class="column is-mobile">
        <div class="carotainer is-interest-container cont-float">
          ...
          <div class="is-text-interest-position" style="z-index:2;">
            <a class="text_interest" style="color:#34a9f7;-webkit-text-stroke: 2px #69c3ff;">michigan sports</a> 
          </div>
        </div>
        <div class="carotainer is-interest-container cont-float">
          <figure class="image is-160x160" style="z-index:1;">
            <img src="~/assets/interests/basketball.png">
          </figure>
          <div class="is-text-interest-position" style="z-index:1;">
            <a class="text_interest" style="color:#fff42b;-webkit-text-stroke: 1px #b5ebff;">basketball</a> 
          </div>
        </div>
        <div class="carotainer is-interest-container cont-float">
          <figure class="image is-160x160" style="z-index:1;">
          ...
          <div class="is-text-interest-position" style="z-index:1;">
            <a class="text_interest" style="color:#fa8c8c;-webkit-text-stroke: 1px #fab1b1;">ducks</a> 
          </div>
        </div>
      </div>
    </div>
