  ...
  <div>
    <div class="columns is-mobile">
      <div class="column is-mobile">
        ...
        <div class="carotainer is-interest-container cont-float">
          <figure class="image is-160x160" style="z-index:1;">
            <img src="~/assets/interests/community.png">
          </figure>
          <div class="is-text-interest-position" style="z-index:1;">
            <a class="text_interest" style="color:#fa8c8c;-webkit-text-stroke: 1px #fab1b1;">community</a> 
          </div>
          <div class="multi-button">
              <svg onclick="https://www.netflix.com/title/70155589', '_blank'" class="icon funbutton" aria-hidden="true">
                <use xlink:href="#icon-netflix"></use>
              </svg>
              <!-- <a> -->
